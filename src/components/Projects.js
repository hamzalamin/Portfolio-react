...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: "SmartBank",
      description: "SmartBank is an application designed to help clients simulate and calculate their loan monthly payments. It provides an intuitive user interface that allows users to easily input loan details and receive accurate calculations. The system ensures efficient loan management and user-friendly experience.",
      link: "https://github.com/hamzalamin/simulation",
      imageUrl: SmartBank,
      technologies: "Java EE, JPA, Hibernate, JSP, JSTL, SASS, JavaScript, JUnit, Mockito, Tomcat",
      category: "fullstack"
    },
    {
      title: "LIBE-UP Library",
      description: "The Library Management System allows users to browse, reserve, and purchase books with different user roles: Admin, Operator, and User. Admins manage book categories and operator accounts, while operators oversee the books, reservations, and customers. Users can reserve books for specified periods and receive email notifications if they fail to return them on time.",
    ...
    },
    {
      ...
      description: "This project involves the development of a RESTful API for managing digital business cards. Built with Laravel and secured using Laravel Sanctum for authentication and access policies, users can create, edit, and delete their own business cards. The API allows users to personalize their business card information and ensures secure interactions with role-based access control.",
    ...
    {
      title: "Evento",
      description: "Evento is an application designed for managing and reserving seats for events. It enables users to browse available events, select seats, and make reservations easily. The platform provides a responsive and user-friendly interface, with interactive features to enhance the user experience. Administrators can manage events and track reservations.",
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-xl font-mono max-w-3xl mx-auto">
            Explore my journey through code. Each project represents a unique challenge solved with passion and precision.
          </p>
        </div>
          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {/* Links - Made explicitly clickable */}
              ...
              {/* Hover Overlay - Reduced opacity and pointer-events-none */}
